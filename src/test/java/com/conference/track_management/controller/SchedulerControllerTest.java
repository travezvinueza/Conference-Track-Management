...
class SchedulerControllerTest {
    ...
    public void testScheduleTalks() throws Exception {
        ...
        List<Track> tracks = Arrays.asList(
                new Track("Track 1",
                        Arrays.asList(
                                new SessionItem("09:00 AM", "Writing Fast Tests Against Enterprise Rails", 60),
                                new SessionItem("10:00 AM", "Overdoing it in Python", 45),
        ...
        mockMvc.perform(post("/v1/cronograma")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonBody))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].trackName").value("Track 1"))
                .andExpect(jsonPath("$[0].networkingEventStart").value("04:00 PM"))
                .andExpect(jsonPath("$[0].morningSession[0].title").value("Writing Fast Tests Against Enterprise Rails"))
